...
function preload(){
  ...
  opc1img=loadAnimation("images/opponent4.png","images/opponent5.png");


  opc2img=loadAnimation("images/opponent1.png","images/opponent2.png");

  opc3img=loadAnimation("images/opponent7.png","images/opponent8.png");
...
function yellowCyclist(){
 ...
 opc1.x= Math.round(random(310,480));
...
function pinkCyclist(){
  if(frameCount % 70 === 0) {
 opc2  = createSprite(200,150,20,20);
 opc2.x = Math.round(random(310,480));
...
function redCyclist(){
 ...
 opc3.x = Math.round(random(310,480));
